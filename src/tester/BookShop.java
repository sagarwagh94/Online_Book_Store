    ...
    public static void main(String[] args) 
{
        ...
        Book book1 = new Book("JAVA", "Herbert Schildt", 1045.50, Category.NON_FICTION,
                LocalDate.of(1984, 10, 20));
        Book book2 = new Book("YOU CAN WIN", "SHIV KHERA", 630.40, Category.FICTION,
                LocalDate.of(1994, 8, 7));
        Book book3 = new Book("CHAWA", "SHIVAJI SAMANT", 699.99, Category.THRILLER, LocalDate.of(2007, 4, 15));
        Book book4 = new Book("RADHEY", "S SAMANT", 600.50, Category.FICTION, LocalDate.of(1962, 2, 6));
